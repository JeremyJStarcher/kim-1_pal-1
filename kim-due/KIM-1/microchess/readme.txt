...
This version of Microchess has been modified to work with the "ca65" compiler, which is more cross-platform than the original TASS compiler.

At the time, the binary file was compared to the original and confirmed byte-for-byte exact.
